...
namespace AdventOfCode2018.Day4
{
    public class Part1
    {
        ...
        {
            var input = File.ReadAllLines("2018/Day4/Input.txt");
            ...
            var sleepyGuard = guards.OrderBy(g => g.GetTotalSleep()).Last();
            Console.WriteLine(sleepyGuard.Id * sleepyGuard.GetMostSleepyMinute());
        }
        ...
        private class Guard
        {
            ...
            public int GetMostSleepyMinute()
            {
                ...
                return minuteDict.OrderByDescending(m => m.Value).First().Key;
            }
        }
